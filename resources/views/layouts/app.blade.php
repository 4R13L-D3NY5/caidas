            ...
            <aside id="sidebar" class="bg-gray-800 text-white overflow-y-auto">
                ...
                <nav class="p-4 space-y-2">
                    ...
                    <a href="{{ route('pacientes.index') }}" 
                        class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-700 transition {{ request()->routeIs('pacientes.index') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('pacientes.gestion') }}" 
                        ...
                        <span>Valoración de Pacientes</span>
                    </a>
